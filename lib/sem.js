...
export async function fetchSemData() {
  ...
  // { spend, pending } — pending is true when a conversion couldn't happen
  // (no live rate for MIXED_CURRENCY_TARGET, or no FIXED_USD_RATES entry
  // for the default case below), so the caller can flag it rather than
  // record a $0.
