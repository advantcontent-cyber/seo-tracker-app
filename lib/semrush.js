...
// Related Keywords for a single seed, high-volume first. Returns
// [{ keyword, volume, kd }] — this report reliably includes Kd.
export async function phraseRelated(seed, database = "us", limit = 25) {
