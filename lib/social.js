...
// (see the connector-name comment above) — both confirmed live 2026-09-25
// against a real Windsor pull (see the full pooled-account list in the
// file-header comment). Only IC Khao Yai is mapped since it's the only
// client with a Social tab so far — add more pairs here (from that same
// pooled list) if another client's Social tab is built later.
export const ACCOUNT_MAP = {
  facebook:  { "InterContinental Khao Yai Resort": "IC Khao Yai" },
  instagram: { "intercontinental_khaoyai": "IC Khao Yai" },
};
